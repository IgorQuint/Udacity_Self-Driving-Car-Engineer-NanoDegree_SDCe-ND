        ...
        if (event == "telemetry") {
          ...
          vector<double> wpy;
                  ...
                  for (int i = 0; i < sensor_fusion.size(); i++) {
                      ...
                      if ((check_car_lane == initlane) && (check_car_s > car_s) && ((check_car_s-car_s) < 30)) {
                          too_close = true;
                      }
                      if ((check_car_lane != initlane) && (check_car_s > car_s) && (check_car_s-car_s) < 15) {
                          OpenLanes[check_car_lane] = false;
                    } else if ((check_car_lane != initlane) && (check_car_s < car_s) && (car_s-check_car_s) < 15) {
                          OpenLanes[check_car_lane] = false;
                      }
                  ...
                  if (too_close) {
                   // 5ms2
                    ...
                    // if not too close, accelerate to max velocity in increments
